...
class Helpers
{
     ...
     * @return bool
     */
    public static function isPasswordProtected($post)
    {
     ...
     * @return bool|WP_Post
     */
    public static function isEnabled($post)
    {
        if (is_array($post)) {
            if (empty($post)) {
                return false;
     ...
     * @return bool|WP_Post
     */
    public static function processPosts($post)
    {
        if (is_array($post)) {
     ...
     * @return bool|WP_Post
     */
    public static function supportsPTC($post)
    {
